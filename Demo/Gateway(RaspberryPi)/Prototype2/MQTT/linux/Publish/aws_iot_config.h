...
#define AWS_IOT_MQTT_CLIENT_ID         "Pub_WS1" // MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "Pub_WS1" // Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "root-CAa4d.crt" // Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "a4db51dcd6-certificate.pem.crt" // device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "a4db51dcd6-private.pem.key" // Device private key filename
// =================================================
