...
void setup()
{
  ...
  e = sx1272.setNodeAddress(3); // 2,3,4
...
void loop()
{
  ...
  if(e<10)
  {
      if (my_packet[0]=='5') { // 4,5,6
        USB.println("");
        USB.println("packet '5' Received");
  ...
  USB.println(humid%10);
        ...
        e = sx1272.sendPacketTimeout(8, buf); // 7,8,9
