...
const int WSN=1; // 1,2,3
int mq135_th=5000; //co2
int mq2_th=1000;
float tmp_th=28;
float humid_th=80;
...
void setup()
{
  ...
  e = sx1272.setNodeAddress(2); // 2,3,4
...
void loop()
{
  ...
  if(e<10)
  {
      if (my_packet[0]=='4') { // 4,5,6
        USB.println("");
        USB.println("packet '4' Received");
  ...
  USB.println(humid%10);
        ...
        e = sx1272.sendPacketTimeout(7, buf); // 7,8,9
