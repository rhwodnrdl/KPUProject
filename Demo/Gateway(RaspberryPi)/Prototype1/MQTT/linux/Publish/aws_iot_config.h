...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1jh97is05aht9.iot.us-west-2.amazonaws.com" // Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 // default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "LoraGateway" // MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "LoraGateway" // Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "root-CA.crt" // Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "47b8252ebf-certificate.pem.crt" // device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "47b8252ebf-private.pem.key" // Device private key filename
// =================================================
...
#define AWS_IOT_MQTT_NUM_SUBSCRIBE_HANDLERS 18 ///< Maximum number of topic filters the MQTT client can handle at any given time. This should be increased appropriately when using Thing Shadow
